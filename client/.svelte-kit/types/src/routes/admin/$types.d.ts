...
type LayoutRouteId = RouteId | "/admin" | "/admin/parcels" | "/admin/parcels/create" | "/admin/parcels/info/[id]" | "/admin/parcels/[id]" | "/admin/users" | "/admin/users/create" | "/admin/users/[id]"
